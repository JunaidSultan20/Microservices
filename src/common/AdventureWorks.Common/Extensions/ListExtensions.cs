...
/// <summary>
/// Provides extension methods for shaping data from a list of objects.
/// </summary>
public static class ListExtensions
{
    /// <summary>
    /// Shapes the data of the objects in the specified list into a list of <see cref="ExpandoObject"/> based on the provided fields.
    /// </summary>
    /// <typeparam name="TSource">The type of the objects in the list.</typeparam>
    /// <param name="source">The list of objects to shape.</param>
    ...
    /// <returns>A list of <see cref="ExpandoObject"/> representing the shaped data of the objects in the list.</returns>
