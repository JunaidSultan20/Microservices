...
public class GetCustomersShapedResponseExample : IExamplesProvider<GetCustomersShapedResponse>
{
    public GetCustomersShapedResponse GetExamples()
    {
        var customerList = new List<CustomerDto>
        {
            new CustomerDto(customerId: 1, personId: 150, storeId: 10, territoryId: 4, accountNumber: "AW10068267B", modifiedDate: null, links: new List<Links>
            {
            ...
            new CustomerDto(customerId: 2, personId: 148, storeId: 50, territoryId: 4, accountNumber: "AW24871696Z", modifiedDate: null, links: new List<Links>
            {
            ...
            new CustomerDto(customerId: 3, personId: 20, storeId: 10, territoryId: 3, accountNumber: "AW26769234A", modifiedDate: null, links: new List<Links>
            {
            ...
            new CustomerDto(customerId: 4, personId: 150, storeId: 10, territoryId: 4, accountNumber: "AW96438732A", modifiedDate: null, links: new List<Links>
            {
            ...
            new CustomerDto(customerId: 5, personId: 20, storeId: 50, territoryId: 1, accountNumber: "AW44680085Z", modifiedDate: null, links: new List<Links>
            {
        ...
        var paginationData = new PaginationData(totalRecords: 100, pageNumber: 1, pageSize: 5, url: "https://www.xyz.com/api/customer");

        return new GetCustomersShapedResponse(result: customerList.ShapeData("id, accountNumber"), pagination: paginationData);
    }
}